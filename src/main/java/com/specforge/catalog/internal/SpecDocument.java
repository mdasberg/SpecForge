...
public class SpecDocument {
     ...
     */
    boolean updateMetadata(String title, String domain, String owningTeam, String owner, Set<String> tags, Instant now) {
     ...
     */
    void changeStatus(SpecStatus status, Instant now) {
        this.status = status;
        this.updatedAt = now;
    }
