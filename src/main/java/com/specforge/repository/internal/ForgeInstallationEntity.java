...
import com.specforge.repository.internal.InstallationStatus;
...
public class ForgeInstallationEntity {
     ...
     */
    void changeStatus(InstallationStatus status, Instant now) {
        this.status = status;
        this.updatedAt = now;
    }
     ...
     */
    @Embeddable
    static class GrantedRepositoryRow {
        ...
        GrantedRepositoryRow(String fullName, String externalId, String defaultBranch) {
