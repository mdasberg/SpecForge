...
import com.specforge.repository.internal.forge.GitHubWebhookSecret;
...
class WebhookVerifier {
    ...
    private final GitHubWebhookSecret secret;

    WebhookVerifier(GitHubWebhookSecret secret) {
        this.secret = secret;
    }
    ...
    boolean verify(String rawBody, String signatureHeader) {
        ...
        byte[] expected = hmac(configured, rawBody);
        byte[] presented;
        try {
