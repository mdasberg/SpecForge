...
public class RepositoryScanEntity {
    ...
    void succeed(int importableCount, int changeProposalCount, int unparsableCount, Instant finishedAt) {
    ...
    void fail(String failureReason, Instant finishedAt) {
