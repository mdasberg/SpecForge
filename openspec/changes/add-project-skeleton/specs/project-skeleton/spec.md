...
Spring Modulith modules with explicit, automatically verified boundaries, backed by one MySQL
...
- **THEN** MySQL and the OIDC provider start, Liquibase applies every migration, and the
